 ...
 * @Package			com.onthegridwebdesign.business_listing
 ...
 * @param int $default
 */
function otgblist_on_off_select ($name, $default) {
	$selected_text = ' selected="selected"';
 ...
 * @param int $default
 */
function otgblist_yes_no_select ($name, $default) {
	$selected_text = ' selected="selected"';
	echo "<select name='$name'>";
	echo '<option value="1"';
	if (1 == $default) echo $selected_text;
 ...
 * @return string
 */
function otgblist_display_yes_no ($value) {
	if ($value)
 ...
 * @return type
 */
function otgblist_select_input_ten ($name) {
 ...
 * @return string
 */
function otgblist_number_select ($name, $min, $max, $selected, $class = '') {
 ...
 */
function otgblist_display_messages ($message_list) {
	// ***** End if Empty *****
	...
	foreach ($message_list as $message) {
		...
		switch ($message[1]) {
			case 1:
				$class = 'otgblist_success';
				break;
			case 2:
				$class = 'otgblist_warning';
				break;
			case 3:
				$class = 'otgblist_error';
				break;
			default:
				$class = 'otgblist_message';
		}
		// ***** Print It *****
